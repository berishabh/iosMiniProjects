...
let story = Story(pages: [
    StoryPage( // 0
        ...
        choices: [
            ...
            Choice(text: "Front of the room", destination: 21),
        ]
    ),
    StoryPage( // 1
        """
        ...
        choices: [
            ...
            Choice(text: "Bainbrows", destination: 6),
    ...
    StoryPage( // 2
        ...
        choices: [
            ...
            Choice(text: "Black velvet", destination: 4),
    ...
    StoryPage( // 3
        ...
        choices: [
            ...
            Choice(text: "Chips", destination: 9),
        ]
    ),
    StoryPage( // 4
        """
    ...
    StoryPage( // 6
        ...
        choices: [
            ...
            Choice(text: "It has no clouds.", destination: 11),
        ]
    ),
    StoryPage( // 7
        """
